...
\section{Usługi typu PaaS oparte o maszyny wirtualne w chmurach publicznych}
...
AWS:
\begin{itemize}
\item \textbf{AWS Elastic Beanstalk} -- aplikacje internetowe oraz mikrousługi
\item \textbf{AWS Lambda} -- platforma serverless; ten typ zostanie szerzej omówiony w sekcji \ref{section:podejscieServerless}
...
\item \textbf{Azure App Service}
	\begin{itemize}
		\item \textbf{Web Apps} -- aplikacje internetowe oraz mikrousługi
		...
		\item \textbf{Functions} -- bazująca na WebJobs platforma serverless; ten typ zostanie szerzej omówiony w sekcji \ref{section:podejscieServerless}
	\end{itemize}
...
Google Cloud:
\begin{itemize}
\item \textbf{Google App Engine} -- platforma tworzenia mikrousług
\item \textbf{Google Cloud Endpoints} -- narzędzia do generowania API i bibliotek na podstawie aplikacji w App Engine
\item \textbf{Google Cloud Functions} -- platforma serverless; ten typ zostanie szerzej omówiony w sekcji \ref{section:podejscieServerless}
...
\section{Usługa konteneryzacji w chmurach publicznych}
...
\section{Serverless} \label{section:podejscieServerless}
