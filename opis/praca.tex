...
\subsubsection{Atrybuty funkcji}
...
\texttt{/api/person/get/grazyna?code=miejsceNaToken}
...
Funkcja może powiadać także \textbf{wiązania} (ang. \textit{bindings}) do danych, wejściowe lub wyjściowe. Może to służyć np. do odczytu danych z Azure Table Storage lub użycia zwracanego przez funkcję obiektu jako nowego wpisu do kolejki. \cite{siteAppBindings}
...
%- Założenie subskrypcji dla studentów
%- wybór sposobu pisania: jako biblioteka, ponieważ wstępnie kompilowane funkcje mają szybciej działać
%- wybór sposobu zapisu danych: Azure Storage, ponieważ CosmosDb jak był zakładany projekt to była jeszcze większa nowość niż teraz, a na Storage było sporo przykładów, w instrukcjach od Azure był pokazany jako podstawowy sposób zapisu danych
%- Visual Studio z doinstalowanymi narzędziami do Azure
%- Azure Storage Emulator
%- MS SQL Server
%- Microsoft Azure Storage Explorer
%- przemyślenie jak powinna wyglądać baza: posłużenie się modelem relacyjnym żeby lepiej wiedzieć o co nam chodzi


\subsection{Pierwsze funkcje}

%- funkcje z dostępem anonimowym - nie wymagają tokenów
%- jak zdefiniować http trigger
%- jak się podłączyć do Storage
%- jak testować?
%1) narzędzia typu Postman
%2) testy jednostkowe
%3) repozytorium + aplikacja testowa w WPF

\subsection{Funkcje z dostępem na klucz}

%- jak się zajebiście dowiedzieć że klucze są z Kudu Services, że nie da się tego przetestować lokalnie

\subsection{Azure Queue Storage}

%- piętrzące się opóźnienia dzięki kolejce
%- zachowanie że jak 5x będzie błąd to dodaje się na kolejkę "poisoned"
...
%- uzasadnienie wyboru narzędzi: czysta Java, kontrolki z szablonu
%- repozytorium
%- cechy
%* asynchroniczna
%* dobrze waliduje wartości
%* korzysta z Accounts Manager
