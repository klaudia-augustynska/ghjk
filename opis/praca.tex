...
% devops to te wszystkie strategie dzięki którym minimalizuje się czas od wprowadznia poprawki do wypuszczenia na produkcję, wszystko co się da jest automatyzowane, termin ukuty w 2009 i od tego czasu określa się nim wszystko co pomaga osiągać taki efekt. Jest mocno związany z chmurami i poniekąd wchodzi w kanon pojęć zwiazanych z chmurą. 
% kontenery mocno stymulują devops gdyż są lekkie i można nimi szybko automatycznie zarządzać, zatem wraz ze wzrostem zainteresowania ideą devops oraz rozwojem rozwiązań chmurowych tak jakoś wyszło że kontenery zyskały wysoką popularność i stanowią kluczowy mechanizm przy kolejnych rozwiązaniach które teraz wojują świat, jak Kubernetes i te jego wszystkie odnogi
