...
%\subsubsection{Rozwój chmur publicznych} \label{chmuryPubliczne}
...
%\subsubsection{Konteneryzacja i DevOps} \label{konteneryzacja}
...
%\subsubsection{Mikrousługi i serverless} \label{mikroserwisy}
...
%\subsubsection{Bazy NoSQL i rozwiązania dla Big Data} \label{nosql}
...
Pierwszą rewolucją było stworzenie systemu bazodanowego (DBMS - ang. \textit{Database Management System}). Wczesne systemy 
